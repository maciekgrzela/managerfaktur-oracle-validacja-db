        ...
        <div class="container">
            <div class="row">
                <div class="col-md-9 col-xs-12">
                    <h1 class="display-5"><a href="dashboard.php" class="text-dark return-btn"> < </a>  Wprowadź wyjasnienie</h1>
                </div>
                <div class="col-md-3 col-xs-12 text-center my-auto">
                    <button type="button" class="btn btn-add-exp btn-lg btn-block btn-info">Dodaj</button>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="col-md-12">
                <form class="form">
                    <div class="form-group">
                        <label for="warning">Wyjasnienie:</label>
                        <textarea class="warn-text form-control" rows="5" id="comment"></textarea>
                    </div>
                </form>
            </div>
        </div>
